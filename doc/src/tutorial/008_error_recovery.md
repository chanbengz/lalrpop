...
If you're using a custom lexer, like Logos, you can still use error recovery with a little extra
work. See error recovery with [custom lexer] for more information.
